...
export const metadata: Metadata = {
  ...
  description: 'Take a virtual tour of HIVY - Place for Celebrations Surat. Explore our romantic rooftop setups, glass houses, and beautiful celebration spaces.',
