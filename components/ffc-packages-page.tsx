              ...
              <Link key={pkg.id} href={`/packages/${pkg.slug}`}>
                <Card className="overflow-hidden border-amber-200 hover:shadow-xl transition-all group h-full">
                  ...
                  <CardContent className="p-3 md:p-4">
                    <h2 className="text-sm md:text-base lg:text-lg font-bold mb-1 group-hover:text-rose-900 transition-colors line-clamp-2">
                      {pkg.name} {pkg.emoji}
                    </h2>
                    ...
                    {/* Price */}
                    <p className="text-lg md:text-xl font-bold text-rose-900">
